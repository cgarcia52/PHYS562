program mtest
    ...
    use numtype
    implicit none
    complex(dp), parameter :: one=(1._dp,0._dp), null=(0._dp,0._dp), &
        zi=(0._dp,1._dp)
    ...
    nn = 3
    a(1:nn, 1:nn) = reshape( (/ 7*one, null, null, null, one, zi, null, -zi, -one /), (/nn,nn/) )
    b(1:nn, 1:nn) = reshape( (/ one, null, zi, null, 2*zi, null, 3*one, null, -5*zi /), (/nn,nn/) )
